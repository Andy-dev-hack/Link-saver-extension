...
export default function InputSection({
  ...
  return (
    <div className="flex flex-col gap-3 pb-3 mb-3 border-b border-dark-border">
      {/* Row 1: Input and Save Link */}
      <div className="flex gap-2 w-full">
        <input
          type="text"
          className="p-2 border border-neon-blue rounded-[5px] grow min-w-[50px] bg-dark-card text-text-main transition-all duration-300 placeholder-text-placeholder"
