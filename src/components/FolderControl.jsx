  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-2 mt-3 mb-2">
        <input
          type="text"
          className="p-2 border border-neon-blue rounded-[5px] flex-[1_1_180px] min-w-[120px] bg-dark-card text-text-main transition-all duration-300 placeholder-text-placeholder"
