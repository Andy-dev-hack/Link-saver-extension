...
export default function FolderItem({ 
    ...
    return (
        <div 
            className={`bg-dark-card rounded-[10px] p-[10px] mb-3 transition-all duration-300 shadow-card border border-transparent max-w-[600px] group ${isSelected ? 'shadow-glow-selected border-neon-blue' : ''}`}
